        ...
        <tbody>
            <?php foreach($usuarios as $usuarios_item): ?>
                <tr role="row" class="odd">
                    ...
                    <td><a href="/admin/usuarios/excluir/<?= $usuarios_item['id']; ?>" 
                    onclick="return confirm('Deseja mesmo Excluir o usuario <?= $usuarios_item['user']; ?>?')">
                    <i class="fas fa-trash"></i> Excluir</a></td>
                </tr>
                        ...
                        <div class="modal-body">
                                <form action="<?= base_url('admin/usuarios/editarSenha') ?>" method="post">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="password" name="senha"/>
                                        <input type="hidden" value="<?= $usuarios_item['id']; ?>" name="id"/>
                                    </div>
                                    <?= csrf_field(); ?>
                        </div>
